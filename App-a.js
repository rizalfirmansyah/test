    ...
    render() {
      return (
        ...
        <Text style={styles.grey}>User settings</Text>
          <View style={{width: 395, height: 150, backgroundColor: 'pink'}}>
        ...
        <View style={{width: 395, height: 50, backgroundColor: 'white'}}>
          <Text style={styles.greyy}>Security level</Text>  
        </View>

        <View style={{width: 395, height: 50, backgroundColor: 'skyblue'}}>
